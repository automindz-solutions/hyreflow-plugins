...
| hyreflow_native | `get_arbeitsagentur_jobs` 0.05 cr | `get_profile_posts` 0.2 cr | 6 paid methods |
...
| prospeo | `bulk_enrich_company` 0.4 cr | `mobile_finder` 3.4 cr | 10 paid methods |
